...
Usage:
    python tools/boot/cbpro_to_mem.py --chip si5340 INPUT.txt -o si5340_init.mem
    python tools/boot/cbpro_to_mem.py --chip ad9640 INPUT.csv -o ad9640_init.mem
    python tools/boot/cbpro_to_mem.py --concat si5340_init.mem ad9640_init.mem ad9117_init.mem \\
                    -o boot_rom.mem
"""
