...
Shared protocol implementation: tools/lib/rf_uart_client.py
GUI version: tools/gui/adda_test_gui_qt.py

Examples:
  python tools/scripts/adc/adc_capture_plot.py -p COM3 -n 256
  python tools/scripts/adc/adc_capture_plot.py -p COM3 -n 1024 --save-csv capture.csv -o wave.png
  python tools/scripts/adc/adc_capture_plot.py --list-ports

Dependencies (see tools/config/requirements.txt):
  pip install -r tools/config/requirements.txt
"""
